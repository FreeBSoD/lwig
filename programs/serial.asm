...
;
; Connect the serial cable to your Lwig machine and Linux machine.
; Start Lwig and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the Lwig machine, you will see a
...
erase_sub:
	...
	start_msg	db 'Lwig minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting Lwig minicom; press a key to return to MikeOS', 13, 10, 0
