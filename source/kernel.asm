; ==================================================================
; LWIG Kernel development (c) 2011 - Fariz Luqman
; Contact me at 2fzweb@gmail.com 
; ==================================================================


	BITS 16

	%DEFINE LWIG_VER '0.0.1'	; OS version number
	%DEFINE LWIG_API_VER 13	; API version for programs to check
...
; and are used in programs/lwigdev.inc so that an external program can
; use a LwigOS system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as LwigOS and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to LWIG', 0
	os_version_msg		db 'Version ', LWIG_VER, 0

	dialog_string_1		db 'Thanks for trying out LWIG Kernel!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute Lwig kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of Lwig, and', 0
